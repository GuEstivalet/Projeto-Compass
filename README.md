...
DISCORD_WEBHOOK_URL="https://discord.com/api/webhooks/1400232546104512663/Ziw-EzxPTf7039BByXDUFwBICp9pGR8uT4hmIYzmPFKvhzXmX4vZlkVS0X-XJhAPal96"
...
Se você configurou um Load Balancer público na sub-rede pública que roteia para o Webserver na sub-rede privada, acesse o DNS do Load Balancer no seu navegador.

Lembre-se: sua instância do Web Server está em uma sub-rede privada e não é diretamente acessível da internet sem um ponto de entrada público (como um Load Balancer).
...
Você deverá ver entradas como: [AAAA-MM-DD HH:MM:SS] Site disponível (Status: 200).
